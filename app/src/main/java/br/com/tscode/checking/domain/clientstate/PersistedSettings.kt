...
data class UserSettings(
    ...
    // Scheduled-pause install defaults: enabled 20:00–07:00 every day, plus full-day Sat/Sun suspension.
...
fun resolvePersistedUserSettings(
    ...
    return UserSettings(
        ...
        scheduledPauseEnabled = record?.scheduledPauseEnabled ?: true,
        scheduledPauseFrom = record?.scheduledPauseFrom ?: "20:00",
        scheduledPauseTo = record?.scheduledPauseTo ?: "07:00",
        suspendSaturdays = record?.suspendSaturdays ?: true,
        suspendSundays = record?.suspendSundays ?: true,
