...
fun enDictionary(): Map<String, Any> = d(
    ...
    "auth" to d(
        ...
        "awaitingApproval" to "Awaiting registration approval.",
        "registrationQueueFull" to "Registration queue is full. Please contact the system administrator.",
    ...
    "history" to d(
        ...
        "colActivity" to "Activity",
        "activityCheckin" to "Check-In",
        "activityCheckout" to "Check-Out",
        "loadError" to "Couldn't load the history.",
        "retry" to "Retry",
    ),
    "registration" to d(
    ...
    "settings" to d(
        ...
        "manualLabel" to "Usage Instructions",
        "aboutLabel" to "About",
        "activitiesLabel" to "Activities",
        "privacyLabel" to "Privacy & Data Protection",
        "groupAccount" to "Account",
        "deleteAccountLabel" to "Remove Account",
        "deleteAccountConfirmTitle" to "Remove Account",
        "deleteAccountConfirmBody" to "This removes your account and erases your data from our servers and this device (key, preferences, saved passwords and local logs). This action cannot be undone. Continue?",
        "deleteAccountConfirm" to "Remove",
        "deleteAccountCancel" to "Cancel",
        "deleteAccountBlocked" to "Could not remove the account from the app. If you have administrative access or opened an accident record, please request removal via the privacy channel (tscode.com.br@gmail.com).",
        "deleteAccountFailed" to "Could not remove the account. Please check your connection and try again.",
        "backButton" to "Back",
    ...
    "manual" to d(
        ...
        "sections" to d(
            ...
            "scheduledPause" to d(
                ...
                "lead" to "Scheduled Pause saves battery by suspending automatic activities during a chosen period (for example, at night).",
                "item1" to "In Settings, tap Scheduled Pause.",
                "item2" to "Enable the option and set the From and To times (for example, 10:00 PM to 6:00 AM).",
                "item3" to "Optionally also enable Suspend on Saturdays and/or Suspend on Sundays. During the pause the app performs no automatic activity and resumes on its own when the period ends.",
            ),
            "accident" to d(
                "title" to "In case of an accident",
                "lead" to "Accident Mode is a safety feature. Use it only in a real emergency.",
                "item1" to "Any user can open Accident Mode; it alerts, in real time, every user on the same project.",
                "item2" to "Report your situation and zone: safe, at the accident site but safe, or at the accident site and needing help. If possible, record a video of the site — it is sent in real time to the administrator dashboard.",
                "item3" to "The Trigger Emergency Service button calls the local emergency service, reporting the accident and location in the regional language.",
            ),
        ),
        "figures" to d(
    ...
    "autoActivities" to d(
        ...
        // Prominent disclosure (Google Play Location Permissions; LGPD art. 9). Shown BEFORE requesting
        // background location, with an affirmative allow/decline choice.
        "bgDisclosureTitle" to "Background location use",
        "bgDisclosureBody" to "Checking collects your location (GPS) even when the app is closed or in the background, solely to automatically check you in and out at your project's registered locations. Your location is sent to Checking's servers, which may be located outside Brazil. You can decline: without this permission Automatic Activities won't work, but manual check-in/out remains available. See the Privacy Policy for details and your rights.",
        "bgDisclosureAccept" to "I understand and allow",
        "bgDisclosureDecline" to "Not now",
    ...
    // LGPD (Law 13.709/2018) — Privacy & Data Protection screen. Same markup as "About":
    // "## " sub-heading, "• " bullet, "! " callout, blank line = paragraph.
    "privacy" to d(
        "heading" to "Privacy & Data Protection",
        "lastUpdatedLabel" to "Last updated",
        "intro" to "This policy explains, clearly and accessibly, how Checking processes your personal data, in accordance with Brazil's General Data Protection Law (Law 13.709/2018 — LGPD).",
        "purposeTitle" to "1. Why we use your data (purpose)",
        "purposeBody" to "Checking is a corporate time-attendance app. We process your data solely to:\n• Record your check-ins and check-outs at your project's workplaces;\n• Perform those records automatically based on your location when you enable Automatic Activities;\n• In case of an accident, coordinate the response and safety (Accident Mode).",
        "dataTitle" to "2. What data we process",
        "dataBody" to "• Identification: your key (4 characters), name, e-mail and the project(s) you belong to;\n• Credentials: your password (stored encrypted);\n• Location (GPS): precise coordinates, also collected in the background when Automatic Activities are on;\n• Attendance records: check-in/check-out history with date, time and location;\n• Accident Mode: video with audio and your status, only when you use it.",
        "legalBasisTitle" to "3. Legal basis (LGPD art. 7)",
        "legalBasisBody" to "We process your attendance data based on the controller's legitimate interest in providing the time-attendance service (art. 7, IX). Background location use occurs under your specific, highlighted consent (art. 7, I), which you can withdraw at any time, free of charge, by disabling Automatic Activities. In Accident Mode, video — which may contain health data — is processed to protect life and physical safety (art. 11, II, 'e'). The international transfer of data relies on art. 33 (adequate contractual safeguards) and does not depend on enabling any feature.",
        "retentionTitle" to "4. How long we keep it (retention)",
        "retentionBody" to "• Attendance history: {retentionHistory};\n• Accident Mode videos: {retentionVideo};\n• On-device Activities log: {retentionLocalDays} days.\nAfter processing ends, data is deleted, except where legal retention applies (LGPD arts. 15 and 16).",
        "sharingTitle" to "5. Sharing and international transfer",
        "sharingBody" to "Checking does NOT sell your data or share it with advertisers. The app uses no advertising, analytics or third-party tracking SDKs.\n\nWe use a hosting/infrastructure provider that acts as an operator, only under our instructions and to host the service — there is no sharing with third parties for their own purposes.\n\n! International transfer (art. 33): that provider is located outside Brazil ({hostingCountry}), so all data is processed and stored abroad. We adopt contractual safeguards to ensure a level of protection adequate to the LGPD.",
        "controllerTitle" to "6. Controller and contact",
        "controllerBody" to "Controller: {controller} (natural person).\nPrivacy and rights contact: {privacyEmail}.\nAs a small-scale processing agent (ANPD Resolution 2/2022), no formal Data Protection Officer is appointed; the e-mail above is the communication channel for data protection matters.",
        "rightsTitle" to "7. Your rights (LGPD art. 18)",
        "rightsBody" to "At any time and free of charge, you may request:\n• Confirmation that we process your data and access to it;\n• Correction of incomplete, inaccurate or outdated data;\n• Anonymization, blocking or deletion of unnecessary or excessive data;\n• Portability and deletion of consent-based data;\n• Information on whom we share data with;\n• Withdrawal of consent.\nTo exercise these rights, use the buttons below or write to our privacy channel. We respond within LGPD deadlines (art. 19).",
        "automatedTitle" to "8. Automated decisions (art. 20)",
        "automatedBody" to "Automatic Activities decide your check-in/check-out automatically based on your location. You have the right to request a review of these decisions through our privacy channel, and you can always turn the feature off and record attendance manually.",
        "securityTitle" to "9. Security (art. 46)",
        "securityBody" to "We adopt technical measures to protect your data: transmission always over HTTPS, passwords and sessions encrypted on the device, and the offline location queue is also encrypted at rest. Access is restricted and protected by app sandboxing.",
        "ageTitle" to "10. Minimum age",
        "ageBody" to "Checking is a corporate tool for workers. It is not directed to people under {minAge} and does not knowingly collect data from children or adolescents.",
        "openFullPolicy" to "Read the full policy (website)",
        "contactDpo" to "Contact us about my data (privacy)",
        "contactSubject" to "Data subject request (LGPD) — key {chave}",
        "contactBody" to "Hello, I would like to exercise my rights under LGPD art. 18 regarding my personal data.\n\nMy key: {chave}\nRequest: (describe: access, correction, deletion, portability, consent withdrawal, etc.)",
        "deleteLocalData" to "Erase data from this device",
        "deleteLocalDataConfirm" to "This erases your locally stored data from this device (key, preferences, saved passwords, local logs and pending locations) and signs you out. Records already sent to the server are not affected — to delete those, use 'Request account deletion'. Continue?",
        "deleteLocalDataDone" to "Local data erased from this device.",
        "requestAccountDeletion" to "Request account and data deletion",
        "confirm" to "Confirm",
        "cancel" to "Cancel",
        "configPendingNotice" to "Privacy configuration pending: controller details are not filled in yet. Complete PrivacyConfig before publishing.",
    ),
    "scheduledPause" to d(
