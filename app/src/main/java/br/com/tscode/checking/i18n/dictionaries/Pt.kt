...
fun ptDictionary(): Map<String, Any> = d(
    ...
    "settings" to d(
        ...
        "privacyLabel" to "Privacidade e Proteção de Dados",
        "groupAccount" to "Conta",
        "deleteAccountLabel" to "Remover Cadastro",
        "deleteAccountConfirmTitle" to "Remover Cadastro",
        "deleteAccountConfirmBody" to "Isto remove sua conta e apaga seus dados dos nossos servidores e deste dispositivo (chave, preferências, senhas salvas e registros locais). Esta ação não pode ser desfeita. Deseja continuar?",
        "deleteAccountConfirm" to "Remover",
        "deleteAccountCancel" to "Cancelar",
        "deleteAccountBlocked" to "Não foi possível remover pelo aplicativo. Se você tem acesso administrativo ou abriu um registro de acidente, solicite pelo canal de privacidade (tscode.com.br@gmail.com).",
        "deleteAccountFailed" to "Não foi possível remover o cadastro. Verifique sua conexão e tente novamente.",
    ...
    // LGPD (Lei 13.709/2018) — tela de Privacidade e Proteção de Dados. O texto usa a mesma marcação do
    // "Sobre": "## " sub-título, "• " item, "! " destaque, linha em branco = parágrafo.
    "privacy" to d(
        "heading" to "Privacidade e Proteção de Dados",
        "lastUpdatedLabel" to "Última atualização",
        "intro" to "Esta política explica, de forma clara e acessível, como o Checking trata seus dados pessoais, em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018 — LGPD).",
        "purposeTitle" to "1. Para que usamos seus dados (finalidade)",
        "purposeBody" to "O Checking é um aplicativo corporativo de controle de ponto. Tratamos seus dados exclusivamente para:\n• Registrar seus check-ins e check-outs nos locais de trabalho do seu projeto;\n• Realizar esses registros automaticamente com base na sua localização, quando você ativa as Atividades Automáticas;\n• Em caso de acidente, coordenar a resposta e a segurança (Modo Acidente).",
        "dataTitle" to "2. Quais dados tratamos",
        "dataBody" to "• Identificação: sua chave (4 caracteres), nome, e-mail e o(s) projeto(s) ao qual você pertence;\n• Credenciais: sua senha (armazenada de forma criptografada);\n• Localização (GPS): coordenadas precisas, coletadas também em segundo plano quando as Atividades Automáticas estão ativas;\n• Registros de ponto: histórico de check-in/check-out com data, hora e local;\n• Modo Acidente: vídeo com áudio e sua situação, apenas quando você o utiliza.",
        "legalBasisTitle" to "3. Base legal (art. 7º da LGPD)",
        "legalBasisBody" to "Tratamos seus dados de ponto com base no legítimo interesse do controlador em oferecer o serviço de controle de ponto (art. 7º, IX). O uso da sua localização em segundo plano ocorre mediante o seu consentimento específico e destacado (art. 7º, I), que você pode revogar a qualquer momento, gratuitamente, desabilitando as Atividades Automáticas. No Modo Acidente, o tratamento de vídeo — que pode conter dados de saúde — funda-se na proteção da vida e da incolumidade física (art. 11, II, 'e'). A transferência internacional dos dados observa o art. 33 (garantias contratuais adequadas) e independe da ativação de qualquer recurso.",
        "retentionTitle" to "4. Por quanto tempo guardamos (retenção)",
        "retentionBody" to "• Histórico de ponto: {retentionHistory};\n• Vídeos do Modo Acidente: {retentionVideo};\n• Registro local de Atividades no aparelho: {retentionLocalDays} dias.\nApós o término do tratamento, os dados são eliminados, salvo obrigação legal de guarda (arts. 15 e 16 da LGPD).",
        "sharingTitle" to "5. Compartilhamento e transferência internacional",
        "sharingBody" to "O Checking NÃO vende seus dados nem os compartilha com anunciantes. O aplicativo não utiliza SDKs de publicidade, analytics ou rastreamento de terceiros.\n\nUtilizamos um provedor de hospedagem/infraestrutura que atua como operador, apenas sob nossas instruções e para hospedar o serviço — não há compartilhamento com terceiros para finalidades próprias deles.\n\n! Transferência internacional (art. 33): esse provedor está localizado fora do Brasil ({hostingCountry}), portanto todos os dados são processados e armazenados no exterior. Adotamos garantias contratuais para assegurar nível de proteção adequado ao previsto na LGPD.",
        "controllerTitle" to "6. Controlador e contato",
        "controllerBody" to "Controlador: {controller} (pessoa natural).\nContato para privacidade e exercício de direitos: {privacyEmail}.\nComo agente de tratamento de pequeno porte (Resolução CD/ANPD nº 2/2022), não há Encarregado formalmente indicado; o e-mail acima é o canal de comunicação para assuntos de proteção de dados.",
        "rightsTitle" to "7. Seus direitos (art. 18 da LGPD)",
        "rightsBody" to "A qualquer momento e gratuitamente, você pode solicitar:\n• Confirmação de que tratamos seus dados e acesso a eles;\n• Correção de dados incompletos, inexatos ou desatualizados;\n• Anonimização, bloqueio ou eliminação de dados desnecessários ou excessivos;\n• Portabilidade e eliminação dos dados tratados com base no consentimento;\n• Informação sobre com quem compartilhamos dados;\n• Revogação do consentimento.\nPara exercer esses direitos, use os botões abaixo ou escreva para o nosso canal de privacidade. Responderemos nos prazos da LGPD (art. 19).",
        "automatedTitle" to "8. Decisões automatizadas (art. 20)",
        "automatedBody" to "As Atividades Automáticas decidem seu check-in/check-out automaticamente com base na sua localização. Você tem direito a solicitar a revisão dessas decisões pelo canal de privacidade, e pode sempre desativar o recurso e registrar seu ponto manualmente.",
        "securityTitle" to "9. Segurança (art. 46)",
        "securityBody" to "Adotamos medidas técnicas para proteger seus dados: transmissão sempre por HTTPS, senhas e sessões criptografadas no aparelho, e a fila de localização offline também é criptografada em repouso. O acesso é restrito e protegido pelo isolamento do aplicativo.",
        "ageTitle" to "10. Idade mínima",
        "ageBody" to "O Checking é uma ferramenta corporativa destinada a trabalhadores. Não é direcionado a menores de {minAge} anos e não coleta intencionalmente dados de crianças ou adolescentes.",
        "openFullPolicy" to "Ler a política completa (site)",
        "contactDpo" to "Falar sobre meus dados (privacidade)",
        "contactSubject" to "Solicitação de titular de dados (LGPD) — chave {chave}",
        "contactBody" to "Olá, gostaria de exercer meus direitos previstos no art. 18 da LGPD referentes aos meus dados pessoais.\n\nMinha chave: {chave}\nSolicitação: (descreva: acesso, correção, exclusão, portabilidade, revogação de consentimento, etc.)",
        "deleteLocalData" to "Apagar dados deste dispositivo",
        "deleteLocalDataConfirm" to "Isto apaga do aparelho seus dados salvos localmente (chave, preferências, senhas salvas, registros locais e localizações pendentes) e encerra a sessão. Os registros já enviados ao servidor não são afetados — para excluí-los, use 'Solicitar exclusão da conta'. Deseja continuar?",
        "deleteLocalDataDone" to "Dados locais apagados neste dispositivo.",
        "requestAccountDeletion" to "Solicitar exclusão da conta e dos dados",
        "confirm" to "Confirmar",
        "cancel" to "Cancelar",
        "configPendingNotice" to "Configuração de privacidade pendente: os dados do controlador ainda não foram preenchidos. Preencha PrivacyConfig antes de publicar.",
    ),
    "scheduledPause" to d(
